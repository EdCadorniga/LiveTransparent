...
- `Forms for GHL/HERO_FORM_CONSENT_COPY.md`
- `Forms for GHL/Transparent_eCom_Legal_Policies.docx`
- `Forms for GHL/PRIVACY_POLICY_FULL_REPLACEMENT_2026-03-24.md`
- `Forms for GHL/TERMS_PAGE_FULL_REPLACEMENT_2026-03-24.md`
...
- consent copy should be updated to match `Forms for GHL/HERO_FORM_CONSENT_COPY.md`
...
3. Replace the privacy policy page body with:
   - `Forms for GHL/PRIVACY_POLICY_FULL_REPLACEMENT_2026-03-24.md`
4. Replace the terms page body with:
   - `Forms for GHL/TERMS_PAGE_FULL_REPLACEMENT_2026-03-24.md`
5. Replace the literal placeholder on the live terms page:
   - replace `{message frequency}`
   - with `Message frequency varies.`
6. Update the Hero form consent copy using:
   - `Forms for GHL/HERO_FORM_CONSENT_COPY.md`
7. Keep the Hero form custom CSS on file using:
   - `Forms for GHL/hero-ghl-form-custom.css`
8. Use the legal policy document as the canonical legal handoff artifact:
   - `Forms for GHL/Transparent_eCom_Legal_Policies.docx`
9. In GHL, set the Hero form consent checkbox to required if submit-time enforcement is desired.
...
- Privacy page:
  - should be replaced with the new full privacy policy content
- Terms page:
  - should be replaced with the new full terms content
  - still contains `{message frequency}`
...
- Append privacy policy block
- Append terms block
- Replace `{message frequency}` placeholder
