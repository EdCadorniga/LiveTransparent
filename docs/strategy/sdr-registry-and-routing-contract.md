...
- SimpleTexting and some social/Vapi paths still contain channel-specific identity or compatibility literals and are not yet registry-driven. The 14 SMS follow-ups in this workflow use `john_sms1` through `john_sms5` keys and are not owner-routed.
