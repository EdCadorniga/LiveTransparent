...
- Reconciliation scripts: `scripts/partnerships/reconcile_august_2026_partnership_live.ps1` and `scripts/partnerships/tag_august_26_partnership_contacts.ps1`. Final source-tag verification: 404/404 tagged, zero errors.
