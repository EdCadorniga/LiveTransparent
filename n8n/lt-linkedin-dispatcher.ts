    ...
    parameters: {
      ...
      assignments: {
        assignments: [
          ...
          { id: 'gKey', name: 'ghlApiKey', type: 'string', value: process.env.GHL_PIT || '<GHL_PIT_FROM_ENV>' },
          { id: 'uBase', name: 'unipileApiBaseUrl', type: 'string', value: 'https://api42.unipile.com:17256/api/v1' },
          { id: 'uKey', name: 'unipileApiKey', type: 'string', value: process.env.UNIPILE_API_KEY || '<UNIPILE_API_KEY_FROM_ENV>' },
