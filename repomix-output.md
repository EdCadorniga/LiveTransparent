...
- **Current blockers**: native GHL widget configuration requires authenticated UI access or an approved internal API path; the four credential-bearing response captures in the worktree must remain untracked.
